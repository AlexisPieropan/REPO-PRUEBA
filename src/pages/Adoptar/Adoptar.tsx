import AdoptarArbolComponent from "../../components/AdoptarArbolComponent/AdoptarArbolComponent"; //lamado al componente hijo
...
const Adoptar = () => {
  ...
  //!! EL FLUJO SERIA : Adoptar.tsx(info arboles) ---> AdoptarArbolComponente.tsx(se le pasa la info por props y se genera las diferentes cards con un bucle)
