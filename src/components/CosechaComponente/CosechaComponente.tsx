...
import imgCosecha from "../../assets/COSECHA2.0.png"; //img de "cosecha" (se puede cambiar)
...
const CosechaComponent = ({ envioId }: { envioId: string }) => {
  ...
  return (
    <div className="p-6 pt-20 md:pt-40 bg-white rounded-lg shadow-md flex flex-col md:flex-row gap-6 justify-center">
      ...
      <div className="md:w-1/2 w-full">
        <h2 className="text-xl pb-10 font-semibold text-gray-800 fuenteTitulo text-center">Seguimiento de Envío</h2>
...
export default CosechaComponent;
